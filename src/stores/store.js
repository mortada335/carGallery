...
//   const getCarByBranch = (branchName, limit=6) => {
//     if (!branchName) return [];
//     const branchKey = branchName.toLowerCase()
//     return cars.value.filter(car=>car.stock[branchKey]).slice(0,limit)
//   }
...
export const useStore = defineStore("store", {
  ...
  actions: {
    ...
    fetchBranches() {
      this.branches = [
        { id: 1, name: "Baghdad", description: "Main Branch In City Center.", image: "/assets/images/b1.jpg" },
        { id: 2, name: "Basra", description: "Second Branch In South.", image: "/assets/images/b2.jpg" },
        { id: 3, name: "Erbil", description: "Third Branch In North.", image: "/assets/images/b3.jpg" },
      ];
    },
  },
});
